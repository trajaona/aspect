//Set the base of the lithosphere as boundary for adiabatic geothermal gradiant.
...
namespace aspect
{
  namespace InitialConditions
  {
    ...
    template <>
    double
    AdiabaticBoundary<2>::get_lithosphere_isotherm(const double,
                                              const double) const
    {       abort();
        	return 0;
    }
    ...
    template <int dim>
    double
    AdiabaticBoundary<dim>::get_lithosphere_isotherm(const double latitude,
