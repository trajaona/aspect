...
#ifndef _aspect_postprocess_model_outputs_h
#define _aspect_postprocess_model_outputs_h
...
namespace aspect
{
  namespace Postprocess
  {
     ...
     */
    template <int dim>
    class ModelOutputs : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
