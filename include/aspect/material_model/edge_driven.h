...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class EdgeDriven : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        ...
        virtual bool is_litho_dislocaion_creep () const;
      ...
      private:
        ...
        double boundary_smoothing(const double &depth,
