...
#ifndef _aspect_initial_temperature_regional_tomography_h
#define _aspect_initial_temperature_regional_tomography_h
  ...
  namespace InitialTemperature
  {
    ...
    class RegionalTomography:  public Utilities::AsciiDataInitial<dim>, public Interface<dim>
    {
      ...
      private:
        ...
        double heat_flow_lab (const double &iso_depth) const; 
        double topo_fac;
        /*
