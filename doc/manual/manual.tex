...
\subsubsection{The  thermochemical composition benchmark}
...
isoviscous Rayleigh-Taylor case (``case 1a'') published by  \textit{et
al.} in \cite{KKSCND97}.
...
\begin{figure}
  ...
  \caption{\it  benchmark (using a smoothed out interface, see the main
  text):
...
Although 's paper title suggests that the paper is really about
...
than 1\% accuracy) with the results in the  paper.
...
\begin{figure}
  ...
  \caption{\it  benchmark with discontinuous (left) and smoothed,
...
lesson in benchmark design; in hindsight, it may also explain why 
...
\begin{figure}
  ...
  \caption{\it  benchmark with discontinuous initial conditions for the
  compositional field:
...
what  \textit{et al.} had agreed upon. To this end, note that the codes
...
given in the paper by  \textit{et al.}, but not exactly where desired
...
In this section we extend the Van Keken cookbook for the work previously completed by \textit{Cedric Thieulot, Juliane Dannberg,Timo Heister and Wolfgang Bangerth.}.
...
\begin{figure}
	...
	\caption{\it  Benchmark (using smoothed out interface): compositional field at time t=0 using smoothing parameter size: a) 0.002, b) 0.02, c) 0.05, d) 0.1, e) 0.2, f) 2}
	\label{fig:vk-5}
\end{figure}
...
\begin{figure}
	...
	\caption{\it  benchmark with smoothed initial conditions for the compositional field using refinement degree 7 for different smoothing parameters.}
	\label{fig:vk-6}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{cookbooks/benchmarks/van-keken/initial_contrast_viscosity.png}
	\caption{\it  benchmark using layers of different viscosities. The left image is the discontinuous case, while right is the smooth.  Both are shown at t=0.}
	\label{fig:vk-7}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{cookbooks/benchmarks/van-keken/final_contrast_viscosity.png}
	\caption{\it  benchmark two-layer viscosity model at final timestep, t=2000. Discontinuous cases are the left images, smooth cases are the right. The upper images are $\frac{\eta_{t}}{\eta_{b}}=0.1$, and the lower are $\frac{\eta_{t}}{\eta_{b}}=0.01$.}
	\label{fig:vk-8}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{cookbooks/benchmarks/van-keken/rms_contrast_viscosity.png}
